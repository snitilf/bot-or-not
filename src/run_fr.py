"""french detection entry point for bot or not challenge. usage: python src/run_fr.py <dataset_path> [--output <output_path>] [--final]"""
...
from fr_detector import detect_bots, detect_bots_final


def main():
    parser = argparse.ArgumentParser(description='Detect French bots')
    ...
    print(f"Running FR detector on {args.dataset}...")
    ...
    if args.output:
        ...
        output_path = f'{args.team}.detections.fr.txt'
